...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen p-8 max-w-6xl mx-auto bg-white text-gray-900 mt-15">
      ...
      <div className="space-y-6 text-lg leading-relaxed whitespace-pre-line">
        ...
        <p>
          The collected personal information could include, but is not limited to: Name, Email Address, Mailing Address, Phone Number, Credit Card, or Net Banking Service Information.
        </p>
        <p>
          You can visit the website anonymously. We will collect personal identification information from you only if you voluntarily submit such information to us.
        </p>
        ...
        <p>
          Our website may use ‘cookies’ to enhance your browsing experience. Cookies help with record-keeping and better tracking of information.  
          You can choose to set your web browser to refuse cookies or alert you when they are being sent. However, note that certain features of the website may not function properly if cookies are disabled.
        </p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Using feedback to improve products and services.</li>
          <li>Processing transactions securely without sharing with outside parties except as required.</li>
          <li>Using non-personal data for targeted advertising through third-party partners.</li>
          <li>Communicating updates, promotions, and requests for feedback via calls, messages, and emails.</li>
        </ul>

        <h2 className="text-2xl font-semibold">Retention Policy</h2>
        <p>
          We retain personal information only for the purpose of providing services and features as described above.
          Subject to legal and regulatory requirements:
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>Identifiable data will not be retained longer than **one year** after the purpose has been fulfilled.</li>
          <li>For ongoing services (e.g., newsletters), data will be retained until a user requests deletion.</li>
        </ul>
        <p>
        ...
        <p className="font-semibold">Email: <a href="mailto:contact@canvas-homes.in" className="text-blue-600 underline">contact@canvas-homes.com</a></p>
        ...
        <h2 className="text-2xl font-semibold">Sharing of Your Personal Information</h2>
        <p>
          We may share your data with third-party service providers to help operate the business, such as sending newsletters or processing payments.
          These third parties are only permitted to use data for the limited purpose defined.
        </p>
        <p>
          Additionally, we may share information with:
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>Law enforcement agencies upon receipt of valid legal processes.</li>
          <li>Affiliates and partner companies under strict privacy agreements.</li>
          <li>Advertising companies for non-personally identifiable data use.</li>
        </ul>
        ...
        <h2 className="text-2xl font-semibold">Your Acceptance of These Terms</h2>
        <p>
          By using our website, you acknowledge and accept this privacy policy. Continued use after policy updates constitutes acceptance of the changes.
        </p>
        ...
        <p className="font-semibold">Email: <a href="mailto:contact@canvas-homes.com" className="text-blue-600 underline">contact@canvas-homes.com</a></p>
      </div>
    </div>
  );
};
