    ...
    <div className="min-h-screen p-8 max-w-6xl mx-auto bg-white text-gray-900 mt-15">
      ...
      <div className="space-y-6 text-lg leading-relaxed whitespace-pre-line">
        ...
        <p>
          ...
          <p><strong>Broker</strong> includes all brokers, channel partners, sales agencies, and third parties who negotiate or act on behalf of one person in a transaction of transfer including sale, purchase, lease, or promotion of properties.</p>
        </p>

        <h2 className="text-2xl font-semibold">INTERPRETATION</h2>
        <p>
          (a) References to legislation include amendments and modifications from time to time.  
          (b) Headings are for reference only and do not affect interpretation.  
        ...
        <p>
          The Privacy Policy governs how user information is collected, used, and stored. By using the Site, you agree to the terms of the Privacy Policy.
        </p>
        ...
        <p>
          Users must be aware of the rules and regulations related to the Real Estate Regulatory Authority (RERA) of the concerned state.
        </p>
        ...
        <p>
          These Terms and Conditions shall be governed by the laws of India, and disputes shall be subject to the exclusive jurisdiction of the courts in Bengaluru.
        </p>
      </div>
    </div>
  );
